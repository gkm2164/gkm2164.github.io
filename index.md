...
* **Part Time Developer**, SMARDI, 
  ...
  * Developed an application for measuring alcohol concentration in breath, which was named A-Scan. This application uses an external device that is connected through the audio connector. The application gathers concentration of alcohol in breath from the device connected to the audio connector and analyzes  the collected data. This application  was successfully deployed to SMARDI on December 2011.
...
* **Research Assistant**	
  * Project: Developing an administration website for the Department of Software Engineering
     * The website is based on PHP and was developed under several important design patterns, such as MVC, Layered architecture. Every service is dealt with object that is instantiation of class
  ...
  * Project: Recovering family trees for slaves during Joseon Dynasty
     * The project was conducted by Academy of East Asian studies in SKKU; helped in
     * making a supporting tool that suggests the relations of slaves during the Joseon Dynasty
     * The researchers referred to  suggestions that were made by the supporting tool to build the family trees
...
* 엘리스, 데이터 사이언스 전문가 양성과정
  * Projects: Parliament Chatbot (Kakao Plus friend: ParChat)

2017.08.28 ~ 2017.08.29:

* C4I/NCW 전문가 과정, 국방과학연구소
  * C4I 통신체계 개론
    * Command, Control, Communications, Computers and Intelligence
    * NCW Network Centric Warfare 개념 소개

2016.07.20 ~ 2017.07.22:

* 요구공학 단기강좌, 소프트웨어 소사이어티
  * 요구사항 주도 개발 방법론에 대한 학습
  * Usecase에 대한 심층적 이해 및 이를 통해 아키텍처로 연결하는 방법에 대해 개괄적으로 학습
...
* Younghun Han, **Gyeongmin Go**, Sungwon Kang, Heuijin Lee, "A Feature-Oriented Mobile Software Development Framework to Resolve the Device Fragmentation Phenomenon for Application Developers in the Mobile Software Ecosystem," The 6th EAI International Conference on Cloud Computing(Cloudcomp 2015), Oct. 28-29, 2015. (Daejeon, Republic of Korea)
	* 안드로이드 대상, 다양한 종류의 디바이스로 인한 단편화 현상에 대한 해결책 중, 마켓에서 디바이스 정보를 구체적으로 명시함으로써 사용자 입장에서 노출되지 않게 하는 연구를 뒷받침하기 위해 제시한 개발자 관점에서의 접근방법 제시
	* PHP기반의 Device Fragmentation Free한 안드로이드 Manifest코드 생성기의 디바이스 매칭 알고리즘 정의
...
* **Gyeongmin Go**, Sungwon Kang, and Jongsun Ahn, “A Software Binding Application Tool based on Orthogonal Variability Description Language for Software Product Line Development,” In Proceedings of 16th IEEE/ACIS International Conference on Software Engineering, Artificial Intelligence, Networking and Parallel/Distributed Computing (SNPD 2015), Takamatsu, Japan, 2015
	* 이전 연구(KCSE제출)에 대해 일부 언어의 모순 개선 및 구조적 측면(언어 스펙 변경 시 수정 용이성 강화, 추가 명령어 제작시 쉽게 변경하도록 함)을 보다 강화함
	* SBAT 정의 수정, 제작, 설명서 제작, C++, Flex & Bison 활용
	* 소스코드: [https://bitbucket.org/gkm2164/sbat-ovdl](https://bitbucket.org/gkm2164/sbat-ovdl)
	* 설명서: [http://bit.ly/2wL85Sw](http://bit.ly/2wL85Sw)

* **고경민**, 강성원, 안종선 “소프트웨어 제품라인 개발을 위한 직교적 가변성 기술 언어 기반의 소프트웨어 바인딩 적용 도구”, 제 17회 한국 소프트웨어공학 학술대회(KCSE 2015), 강원도 평창, 2015.
	* 소프트웨어 제품라인 가변성 모델링 언어인 OVDL을 응용하여 Variability Aware 소프트웨어 구성(빌드) 도구 제작, 가변 지점에 가변 값을 대입하는 행위를 바인딩 적용이라 하여, 이를 바인딩 적용 도구(SBAT)라 정의
	* SBAT 정의 
